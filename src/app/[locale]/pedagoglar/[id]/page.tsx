...
const SingleEducator = () => {
  ...
  const educators: PedagogueType[] = [
    ...
    },
    {
      ...
      img: EducatorImage12,
      name: "Fayziyev Adham",
      desc: "Doktor (DSc) Filologiya fanlari doktori",
      faculty: "1",
    },
    {
      id: "pedagog-13",
      img: EducatorImage13,
      name: "Rustamov Umid",
      desc: "Professor Iqtisodiyot fanlari bo'yicha mutaxassis",
      faculty: "1",
    },
    {
      id: "pedagog-14",
      img: EducatorImage14,
      name: "Sattikulov Muzaffar",
      desc: "Dotsent Iqtisodiyot fanlari nomzodi",
      faculty: "1",
    },
    {
      id: "pedagog-15",
      img: EducatorImage15,
      name: "Kusharov Zoxid",
      desc: "Informatika bo'yicha mutaxassis",
      faculty: "1",
    },
  ];
  ...
  const data = [
    {
      ...
      media: [
        {
          name: t("educator.media1"),
          value: "book",
        },
        {
          name: t("educator.media2"),
          value: "cert",
        },
        {
          name: t("educator.media3"),
          value: "something",
        },
      ],
      data: {
  ...
  const changeBookStatus = (value: string) => {
    setPage(page === value ? "" : value);
  };
  return (
      ...
      <div className="max-w-[1320px] w-full">
        <div className="flex gap-5 mb-2">
          <div className="max-w-[400px] h-full flex flex-col gap-3 justify-between items-center">
            <Image
              ...
              width={400}
              height={700}
              className=" rounded-[10px] mb-[10px] min-w-[400px] h-[515px] w-full object-cover"
            />
        ...
        <div className="flex gap-8 items-start mt-10">
          <div className="flex flex-col">
            ...
            <h4 className="text-[40px] font-[500] mb-[10px] mt-5">
              {data[0]?.data?.title}
            </h4>
          ...
          <div className="grid grid-cols-3 gap-10 w-[65%]">
            {data[0]?.media?.map((item, index) => {
              return (
                <button
                  key={index}
                  className="text-[24px] p-4 rounded-[10px] bg-[#404B7C] text-white"
                  onClick={() => changeBookStatus(item.value)}
                >
                  {item.name}
                </button>
              );
            ...
            {page === "book" && (
              <div
                className={`${
                  page === "book" ? "opacity-[1]" : "opacity-[0]"
                } ease-linear duration-200 flex flex-col gap-2 whitespace-nowrap`}
              >
