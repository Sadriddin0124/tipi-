...
const Statistics = () => {
    ...
    const data = [
        {title: t("statistics.item1"), count: 11000, icon: Statistics1, start: 0, plus: true, increase: 50,}, 
        {title: "", count: 0, icon: "", start: 0, plus: false, increase: 0},
        {title: t("statistics.item2"), count: 400, icon: Statistics2, start: 0, plus: true, increase: 3,}, 
        {title: "", count: 0, icon: "", start: 0, plus: false, increase: 0},
        {title: t("statistics.item3"), count: 1000000000, icon: Statistics3, start: 0, plus: false, increase: 5000000},
    ]
  return (
