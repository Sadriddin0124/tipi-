    ...
    <header className='max-h-[577px] h-[100%] w-full relative rounded-b-[40px] overflow-hidden'>
      ...
      <div className='h-[577px] w-[50%] relative z-20 flex justify-center items-center'>
        ...
        <div className='flex flex-col gap-5 items-center'>
            <button className='btn_gradient text-[24px] rounded-[10px] gap-3 text-white'><span className='flex items-center px-4 py-3 gap-3'>{btn}<FaArrowRightLong size={30}/></span></button>
        </div>
      </div>
    </header>
  )
