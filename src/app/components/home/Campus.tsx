...
const Campus = () => {
  ...
  return (
    <section className='w-[100%] min-h-[250px] sm:min-h-[450px] h-full relative flex flex-col md:flex-row justify-center items-center' data-aos="fade-up">
      <Image src={CampusImage} alt='Campus Image' className='absolute brightness-90 w-full min-h-[250px] sm:min-h-[300px] rounded-2xl z-[-1] object-cover' width={1600} height={400}/>
