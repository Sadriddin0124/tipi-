                    ...
                    return <div key={index} className='px-3 lg:px-5'>
                        <div className='shadow-md rounded-[10px] overflow-hidden'>
                          ...
                          <div className='p-5 flex flex-col items-start justify-between gap-[10px] min-h-[220px]'>
                              ...
                              <Link href={`/${activeLang?.value}/pedagoglar/${item?.id}`} className='hover:bg-white self-end text-white px-6 py-3 rounded-lg border-2 border-transparent hover:border-[#404B7C] ease-linear duration-200 bg-[#404B7C] hover:text-[#404B7C]'>{t("pedagogue.btn")}</Link>
                          </div>
                      </div>
                    </div>
                })
