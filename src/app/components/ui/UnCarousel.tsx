          ...
          <div className='px-[2px] py-[30px] w-full max-w-[350px]' key={index}>
            <div key={index} className='rounded-[10px] overflow-hidden shadow-lg flex flex-col'>
              ...
              <div className='pt-[26px] px-[18px] pb-[20px] text_main flex flex-col gap-4'>
                ...
                <p className='text-[17px] max-h-[50px] min-h-[60px] font-[600] line-clamp-3 overflow-hidden text-center leading-5'>{locale === "ru" ? item?.name_ru : locale === "uz" ? item?.name_uz : item?.name_en}</p>
                <Link
